...
class MainPage(BasePage):
    ...
    @allure.step('Переходим на страницу аккаунта')
    def click_account_button(self):
        self.redirect(self.account_link_button, self.account_link_button)

    @allure.step('Переходим на страницу со списком заказов')
    def click_feed_button(self):
        self.redirect(self.feed_link_button, self.account_link_button)

    @allure.step('Кликаем на ингридиент по его имени')
    ...
    @allure.step('Получаем количество ингридиента в заказе по его имени')
    ...
    @allure.step('Добавляем ингридент с указанным именем')
    ...
    @allure.step('Проверяем доступна ли кнопка заказа')
    ...
    @allure.step('Закрываем попап нового заказа')
